...
parcelRegister("kpSEx", function(module, exports) {

$parcel$export(module.exports, "ESP32P4ROM", () => $edd08957a4ae4737$export$80700ef855e8973d);

var $jg3aN = parcelRequire("jg3aN");
class $edd08957a4ae4737$export$80700ef855e8973d extends (0, $jg3aN.ESP32ROM) {
    constructor(){
        super(...arguments);
        ...
        this.PMU_ANA_0P1A_EN_CUR_LIM_0 = 134217728;
        this.PMU_EXT_LDO_P0_0P1A_REG = this.DR_REG_PMU_BASE + 0x1b8;
        this.PMU_0P1A_TARGET0_0 = 2139095040;
        ...
        this.RTC_CNTL_SWD_AUTO_FEED_EN = 262144;
    ...
    async getStubJsonPath(loader) {
        ...
        if (chipRevision < 300) return "./targets/stub_flasher/stub_flasher_32p4rc1.json";
     ...
     */ async watchdogReset(loader) {
        ...
        await loader.writeReg(this.RTC_CNTL_WDTCONFIG0_REG, -805306110); // enable WDT
     ...
     */ async powerOnFlash(loader) {
        ...
        // }
        const chipRev = await this.getChipRevision(loader);
        if (chipRev <= 300) // <=ECO5: The flash chip is powered off by default on >=ECO6, when the default flash
...
//# sourceMappingURL=esp32p4.e6d139ac.js.map
